...
function RouteTrackingStrip() {
  const routes = ['BORROWDALE', 'MT PLEASANT', 'GREENDALE', 'AVONDALE', 'HIGHLANDS', 'MSASA', 'NORTON', 'CHITUNGWIZA', 'RUWA'];
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-6">
            <div>
              <p className="text-cyan-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Moving Solutions</p>
    ...
    <section ref={containerRef} className="bg-navy-950 py-24 sm:py-32 lg:py-40 overflow-hidden">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 mb-12 sm:mb-16">
        ...
        >
          <div>
            <div className="w-12 h-[3px] bg-cyan-500 mb-6" />
            <p className="text-cyan-500/60 text-xs uppercase tracking-[0.3em] mb-3" style={{ fontFamily: 'var(--font-sans)' }}>Recent Moves</p>
            <h2 className="font-heading text-white leading-[0.92]" style={{ fontSize: 'clamp(2rem, 5vw, 4rem)' }}>
              Successfully <span className="text-cyan-500">Moved</span>
            </h2>
          </div>
          <Link
            to="/projects"
...
function WhyChooseUs() {
  ...
  const points = [
    { title: 'Full-Service Moving', desc: 'Packing, loading, transport, and unpacking. We handle every step of your move.' },
    { title: 'Truck Hire', desc: 'Need a truck without full moving service? Hire our vehicles by the hour or day.' },
    { title: 'Insured Moves', desc: 'Every move is insured against transit damage. Your belongings are protected door to door.' },
    { title: 'Weekend Service', desc: 'We work Saturdays and Sundays at no extra charge. Move when it suits you.' },
  ];
